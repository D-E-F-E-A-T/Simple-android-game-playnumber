...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (a.hasValue(C0207R.styleable.Toolbar_titleMargins)) {
            titleMargin = a.getDimensionPixelOffset(C0207R.styleable.Toolbar_titleMargins, titleMargin);
        }
        ...
        if (a.hasValue(C0207R.styleable.Toolbar_titleTextColor)) {
            ...
            i = -1;
            setTitleTextColor(a.getColor(C0207R.styleable.Toolbar_titleTextColor, -1));
        } else {
            i = -1;
        }
        if (a.hasValue(C0207R.styleable.Toolbar_subtitleTextColor)) {
            setSubtitleTextColor(a.getColor(C0207R.styleable.Toolbar_subtitleTextColor, i));
        }
        a.recycle();
    }
