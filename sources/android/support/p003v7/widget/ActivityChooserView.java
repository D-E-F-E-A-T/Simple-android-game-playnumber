...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (itemViewType == 0) {
                ...
                if (convertView == null || convertView.getId() != 1) {
                    convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C0207R.layout.abc_activity_chooser_view_list_item, parent, false);
                    convertView.setId(1);
                    ((TextView) convertView.findViewById(C0207R.C0209id.title)).setText(ActivityChooserView.this.getContext().getString(C0207R.string.abc_activity_chooser_view_see_all));
                }
                return convertView;
            } else {
                throw new IllegalArgumentException();
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        LayoutInflater.from(getContext()).inflate(C0207R.layout.abc_activity_chooser_view, this, true);
