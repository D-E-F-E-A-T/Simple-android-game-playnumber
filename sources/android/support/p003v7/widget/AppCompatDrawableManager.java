...
public final class AppCompatDrawableManager {
    private static final int[] COLORFILTER_COLOR_BACKGROUND_MULTIPLY = {C0207R.C0208drawable.abc_popup_background_mtrl_mult, C0207R.C0208drawable.abc_cab_background_internal_bg, C0207R.C0208drawable.abc_menu_hardkey_panel_mtrl_mult};
    private static final int[] COLORFILTER_COLOR_CONTROL_ACTIVATED = {C0207R.C0208drawable.abc_textfield_activated_mtrl_alpha, C0207R.C0208drawable.abc_textfield_search_activated_mtrl_alpha, C0207R.C0208drawable.abc_cab_background_top_mtrl_alpha, C0207R.C0208drawable.abc_text_cursor_material, C0207R.C0208drawable.abc_text_select_handle_left_mtrl_dark, C0207R.C0208drawable.abc_text_select_handle_middle_mtrl_dark, C0207R.C0208drawable.abc_text_select_handle_right_mtrl_dark, C0207R.C0208drawable.abc_text_select_handle_left_mtrl_light, C0207R.C0208drawable.abc_text_select_handle_middle_mtrl_light, C0207R.C0208drawable.abc_text_select_handle_right_mtrl_light};
    private static final int[] COLORFILTER_TINT_COLOR_CONTROL_NORMAL = {C0207R.C0208drawable.abc_textfield_search_default_mtrl_alpha, C0207R.C0208drawable.abc_textfield_default_mtrl_alpha, C0207R.C0208drawable.abc_ab_share_pack_mtrl_alpha};
    ...
    private static final int[] TINT_CHECKABLE_BUTTON_LIST = {C0207R.C0208drawable.abc_btn_check_material, C0207R.C0208drawable.abc_btn_radio_material};
    private static final int[] TINT_COLOR_CONTROL_NORMAL = {C0207R.C0208drawable.abc_ic_commit_search_api_mtrl_alpha, C0207R.C0208drawable.abc_seekbar_tick_mark_material, C0207R.C0208drawable.abc_ic_menu_share_mtrl_alpha, C0207R.C0208drawable.abc_ic_menu_copy_mtrl_am_alpha, C0207R.C0208drawable.abc_ic_menu_cut_mtrl_alpha, C0207R.C0208drawable.abc_ic_menu_selectall_mtrl_alpha, C0207R.C0208drawable.abc_ic_menu_paste_mtrl_am_alpha};
    private static final int[] TINT_COLOR_CONTROL_STATE_LIST = {C0207R.C0208drawable.abc_tab_indicator_material, C0207R.C0208drawable.abc_textfield_search_material};
    ...
    private Drawable createDrawableIfNeeded(Context context, int resId) {
        ...
        if (resId == C0207R.C0208drawable.abc_cab_background_top_material) {
            dr = new LayerDrawable(new Drawable[]{getDrawable(context, C0207R.C0208drawable.abc_cab_background_internal_bg), getDrawable(context, C0207R.C0208drawable.abc_cab_background_top_mtrl_alpha)});
        }
        if (dr != null) {
    ...
    private Drawable tintDrawable(Context context, int resId, boolean failIfNotKnown, Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            return drawable2;
        } else if (resId == C0207R.C0208drawable.abc_seekbar_track_material) {
            LayerDrawable ld = (LayerDrawable) drawable;
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
            ...
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, C0207R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, C0207R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
    ...
    public synchronized ColorStateList getTintList(Context context, int resId) {
        ...
        if (tint == null) {
            if (resId == C0207R.C0208drawable.abc_edit_text_material) {
                tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_edittext);
            } else if (resId == C0207R.C0208drawable.abc_switch_track_mtrl_alpha) {
                tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_switch_track);
            } else if (resId == C0207R.C0208drawable.abc_switch_thumb_material) {
                tint = createSwitchThumbColorStateList(context);
            } else if (resId == C0207R.C0208drawable.abc_btn_default_mtrl_shape) {
                tint = createDefaultButtonColorStateList(context);
            } else if (resId == C0207R.C0208drawable.abc_btn_borderless_material) {
                tint = createBorderlessButtonColorStateList(context);
            } else if (resId == C0207R.C0208drawable.abc_btn_colored_material) {
                tint = createColoredButtonColorStateList(context);
            } else {
                if (resId != C0207R.C0208drawable.abc_spinner_mtrl_am_alpha) {
                    if (resId != C0207R.C0208drawable.abc_spinner_textfield_background_material) {
                        if (arrayContains(TINT_COLOR_CONTROL_NORMAL, resId)) {
                            tint = ThemeUtils.getThemeAttrColorStateList(context, C0207R.attr.colorControlNormal);
                        } else if (arrayContains(TINT_COLOR_CONTROL_STATE_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_default);
                        } else if (arrayContains(TINT_CHECKABLE_BUTTON_LIST, resId)) {
                            tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_btn_checkable);
                        } else if (resId == C0207R.C0208drawable.abc_seekbar_thumb_material) {
                            tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_seek_thumb);
                        }
                    }
                }
                tint = AppCompatResources.getColorStateList(context, C0207R.color.abc_tint_spinner);
            }
            if (tint != null) {
    ...
    private void checkVectorDrawableSetup(Context context) {
        if (!this.mHasCheckedVectorDrawableSetup) {
            ...
            Drawable d = getDrawable(context, C0207R.C0208drawable.abc_vector_test);
