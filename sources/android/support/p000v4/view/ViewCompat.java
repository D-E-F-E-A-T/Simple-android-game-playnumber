...
public class ViewCompat {
    ...
    public static void addOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map map = (Map) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
            if (map == null) {
                map = new ArrayMap();
                v.setTag(C0021R.C0023id.tag_unhandled_key_listeners, map);
            }
        ...
        ArrayList arrayList = (ArrayList) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
        if (arrayList == null) {
            arrayList = new ArrayList();
            v.setTag(C0021R.C0023id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static void removeOnUnhandledKeyEventListener(View v, OnUnhandledKeyEventListenerCompat listener) {
        if (VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0021R.C0023id.tag_unhandled_key_listeners);
            if (viewListeners != null) {
